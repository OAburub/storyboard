...
**Best for**: ANY concept that benefits from visual explanation — not just "complex" ones
**Structure**: Custom SVG generated by Gemini AI
**SVG is a PRIMARY visualization tool.** Ask: "Would seeing this as a picture help the learner understand faster?"
